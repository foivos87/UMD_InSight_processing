...
def data_process_2(event2find):
    ...
    filenameZ = (path + '/' + event2find + '_BHZ_' + comp + '.sac')
    filenameN = (path + '/' + event2find + '_BHN_' + comp + '.sac')
    filenameE = (path + '/' + event2find + '_BHE_' + comp + '.sac')
    st_new1[0].write(filenameZ, format = 'SAC')
    st_new1[1].write(filenameN, format = 'SAC')
    st_new1[2].write(filenameE, format = 'SAC')
